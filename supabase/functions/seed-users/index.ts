...
const PERSONAS = [
  ...
  { suffix: 67, username: "valerieseeks", avatar_id: 32, bio: "Need parts for a vintage Singer sewing machine restoration.", region: "Hartford, CT" },
  { suffix: 68, username: "willhunts", avatar_id: 28, bio: "Searching for handmade bamboo fly fishing rods.", region: "Anchorage, AK" },
  { suffix: 69, username: "ximenascouts", avatar_id: 34, bio: "Looking for rare Latin music vinyl. Fania Records pressings.", region: "Miami, FL" },
  { suffix: 70, username: "yorickfinds", avatar_id: 27, bio: "Need a vintage telescope. Unitron, Questar, Cave Astrola.", region: "Flagstaff, AZ" },
];
