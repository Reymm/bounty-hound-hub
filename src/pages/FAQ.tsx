...
const faqData = [
  ...
  },
  {
    ...
    questions: [
      {
        q: "What are the fees?",
        a: "POSTERS: No platform fee. You pay the bounty reward + Stripe processing (~2.9% + $0.30). HUNTERS: $2 + 5% platform fee, plus small transfer fee (~0.25% + $0.25), deducted from your payout. Example: $100 bounty → hunter receives ~$92.27."
      },
      {
