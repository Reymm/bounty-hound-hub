  ...
  async getProfile(userId: string): Promise<Profile | null> {
    try {
      ...
      return {
        ...
        idvStatus: profileData.identity_verified ? IdvStatus.VERIFIED : IdvStatus.NOT_VERIFIED,
        hasPayoutMethod: profileData.stripe_connect_payouts_enabled || false,
  ...
  async updateProfile(userId: string, updates: { displayName?: string; username?: string; bio?: string; region?: string; avatarUrl?: string; payoutCountry?: string; payoutEmail?: string }): Promise<Profile | null> {
    try {
      ...
      return {
        ...
        idvStatus: data.identity_verified ? IdvStatus.VERIFIED : IdvStatus.NOT_VERIFIED,
        hasPayoutMethod: data.stripe_connect_payouts_enabled || false,
